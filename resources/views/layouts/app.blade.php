...
@if (!Auth::guest())
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        {!! Auth::user()->name !!}
                                        <small>@lang('messages.user-join-at') {!! Auth::user()->created_at->format('M. Y') !!}</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            <strong>Copyright © 2018 <a href="#">PVT</a>.</strong> All rights reserved.
        </footer>
...
<script>
    ...
    var updateTree = function (e, data) {
        var $tree = $(this);
        data = '';
