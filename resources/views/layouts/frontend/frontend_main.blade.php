    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="{!! url('/register') !!}"><span class="glyphicon glyphicon-user"></span> @lang('messages.register')</a></li>
                @if (!Auth::guest())
                 ...
                 @else
                    <li><a href="{!! url('/login') !!}"><span class="glyphicon glyphicon-log-in"></span> @lang('messages.login')</a></li>
                @endif
            </ul>
        </div>
    </div>
