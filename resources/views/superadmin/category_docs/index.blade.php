...
@section('content')
    <section class="content-header">
        ...
        {!! Breadcrumbs::render('superadmin.categoryDocs.index') !!}
    </section>
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <a class="btn btn-primary" href="{!! route('superadmin.categoryDocs.create') !!}"><i class="fa fa-plus"></i> @lang('messages.create')</a>
...
$('#items').submit();}")) }}
            ...
            <div class="box-header with-border">
                <div class="box-tools-search">
                    {!! Form::open(['method'=>'GET','url'=>'/superadmin/categoryDocs','role'=>'search'])  !!}
                    <div class="form-inline text-right">
                        ...
                        <a class="btn btn-warning" href="{!! route('superadmin.categoryDocs.index') !!}"><i class="fa fa-eraser"></i> @lang('messages.reset')</a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
            <div class="box-body">
                {!! Form::open(['id' =>'items', 'route' => ['superadmin.categoryDocs.destroy', 'MULTI'], 'method' => 'delete']) !!}
                {!! Form::close() !!}
                @include('superadmin.category_docs.table')
            </div>
        </div>
    </section>
@endsection
