    ...
    @else
        @foreach($categoryDocs as $key => $categoryDoc)
            <tr>
                ...
                <td width="100px">
                    {!! Form::open(['route' => ['superadmin.categoryDocs.destroy', $categoryDoc->id], 'method' => 'delete']) !!}
                    <div class='btn-group'>
                        <a href="{!! route('superadmin.categoryDocs.show', [$categoryDoc->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                        <a href="{!! route('superadmin.categoryDocs.edit', [$categoryDoc->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
