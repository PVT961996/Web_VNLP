...
class FileController extends FrontendBaseController
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.file.index',compact('documents','files','category_docs','recent_posts'));
    }
    ...
    public function show($id)
    {
        ...
        return view('frontend.file.show', compact('documents','file','category_docs','recent_posts'));
    }
