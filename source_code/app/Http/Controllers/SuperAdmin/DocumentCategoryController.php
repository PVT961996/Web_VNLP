...
use App\Http\Requests\Superadmin\CreateDocumentCategoryRequest;
use App\Http\Requests\Superadmin\UpdateDocumentCategoryRequest;
...
class DocumentCategoryController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('superadmin.document_categories.index')
    ...
    {
        return view('superadmin.document_categories.create');
    }
    ...
    public function store(CreateDocumentCategoryRequest $request)
    {
        ...
        return redirect(route('superadmin.documentCategories.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('superadmin.document_categories.show')->with('documentCategory', $documentCategory);
    }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin.document_categories.edit')->with('documentCategory', $documentCategory);
    }
