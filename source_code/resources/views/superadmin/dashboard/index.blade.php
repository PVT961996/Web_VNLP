...
@section('content')
    <section class="content-header">
        ...
        {!! Breadcrumbs::render('superadmin.dashboard.index') !!}
    </section>
    <div class="container">
        <br>
...
//                        console.log(url);
        ...
        <br>
            <div class="form-group col-md-4"><input class="form-control" type="text" id="path_text" value="qtv.fan/posts/" placeholder="Nhập đường dẫn bài viết"/></div>
            <div class="form-group col-md-2"><input class="btn btn-primary" type="button" onclick="getPath()" value="Gửi"/></div>
