...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('confirmed',[''=>__('messages.selected'),1=>Helper::convertActived(1), 2=>Helper::convertActived(2),3=>Helper::convertActived(3)] ,null, ['class' => 'form-control']) !!}
</div>
<!-- Submit Field -->
<div class="form-group col-sm-12">
    {{ Form::button('<i class="fa fa-save"></i> '.Lang::get('messages.save'), array('class'=>'btn btn-primary', 'type'=>'submit')) }}
    <a href="{!! route('superadmin.users.index') !!}" class="btn btn-default"><i
